...
#GLOVE_DIR="/media/philippe/5f695998-f5a5-4389-a2d8-4cf3ffa1288a/data/embeddings"
f = gzip.open(os.path.join(GLOVE_DIR, 'glove.6B.100d.txt.gz'),'r')
#f = gzip.open(os.path.join(GLOVE_DIR, 'glove.840B.300d.txt.gz'),'r')
for line in f:
    values = line.split()
    word = values[0]
...
tmpMatrix = np.zeros((len(embeddings_index), embeddings)) #Initialize tmpMatrix for mean
counter = 0
...
postTextEmbedding = np.zeros((len(postTextTokenizer.word_index) + 1, embeddings)) #Initialize Embedding matrix
unknownWords = 0
...
targeTitleEmbedding = np.zeros((len(targetTitleTokenizer.word_index) + 1, embeddings)) #Initialize Embedding matrix
unknownWords = 0
...
targetDescriptionEmbedding = np.zeros((len(targetDescriptionTokenizer.word_index) + 1, embeddings)) #Initialize Embedding matrix
unknownWords = 0
...
targetKeywordEmbedding = np.zeros((len(targetKeywordsTokenizer.word_index) + 1, embeddings)) #Initialize Embedding matrix
unknownWords = 0
...
targetParagraphEmbedding = np.zeros((len(targetParagraphTokenizer.word_index) + 1, embeddings)) #Initialize Embedding matrix
unknownWords = 0
...
postTextBranch.add(Conv1D(filters=nb_filter,
                        kernel_size=filter_length,
                          padding='valid',
                        activation='relu',
                        strides=1))
# we use max pooling:
postTextBranch.add(GlobalMaxPooling1D())
postTextBranch.add(BatchNormalization())
...
postTextBranch.save('/home/philippe/PycharmProjects/deepLearning/clickbait/models/postTextBranchRegCNN.h5')
...
targetTitleBranch.add(Conv1D(filters=nb_filter,
                        kernel_size=filter_length,
                          padding='valid',
                        activation='relu',
                        strides=1))
# we use max pooling:
targetTitleBranch.add(GlobalMaxPooling1D())
targetTitleBranch.add(BatchNormalization())
...
targetTitleBranch.save('/home/philippe/PycharmProjects/deepLearning/clickbait/models/targetTitleBranchRegCNN.h5')
...
descriptionBranch.add(Conv1D(filters=nb_filter,
                        kernel_size=filter_length,
                          padding='valid',
                        activation='relu',
                        strides=1))
# we use max pooling:
descriptionBranch.add(GlobalMaxPooling1D())
descriptionBranch.add(BatchNormalization())
...
descriptionBranch.save('/home/philippe/PycharmProjects/deepLearning/clickbait/models/descriptionBranchRegCNN.h5')
...
keywordsBranch.add(Conv1D(filters=nb_filter,
                        kernel_size=filter_length,
                          padding='valid',
                        activation='relu',
                        strides=1))
# we use max pooling:
keywordsBranch.add(GlobalMaxPooling1D())
keywordsBranch.add(BatchNormalization())
...
keywordsBranch.save('/home/philippe/PycharmProjects/deepLearning/clickbait/models/keywordsBranchRegCNN.h5')
...
paragraphBranch.add(Conv1D(filters=nb_filter,
                        kernel_size=filter_length,
                          padding='valid',
                        activation='relu',
                        strides=1))
# we use max pooling:
paragraphBranch.add(GlobalMaxPooling1D())
paragraphBranch.add(BatchNormalization())
...
paragraphBranch.save('/home/philippe/PycharmProjects/deepLearning/clickbait/models/paragraphBranchRegCNN.h5')
...
hourBranch.save('/home/philippe/PycharmProjects/deepLearning/clickbait/models/hourBranchRegCNN.h5')
...
with open("/home/philippe/PycharmProjects/deepLearning/clickbait/models/modelRegCNN.yaml", "w") as yaml_file:
    yaml_file.write(model_yaml)
final_model.save_weights('/home/philippe/PycharmProjects/deepLearning/clickbait/models/weightRegCNN.h5')
...
model_yaml = final_model.to_yaml()
with open("/home/philippe/PycharmProjects/deepLearning/clickbait/models/modelRegFullCNN.yaml", "w") as yaml_file:
    yaml_file.write(model_yaml)
final_model.save_weights('/home/philippe/PycharmProjects/deepLearning/clickbait/models/weightRegFullCNN.h5')
